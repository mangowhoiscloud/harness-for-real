...
## Build & Test
<!-- init.sh populates these based on detected project type -->
<!-- HARNESS:BUILD_CMD=echo "run init.sh first" -->
<!-- HARNESS:TEST_CMD=echo "run init.sh first" -->
<!-- HARNESS:LINT_CMD=echo "run init.sh first" -->
<!-- HARNESS:TYPECHECK_CMD=echo "run init.sh first" -->
